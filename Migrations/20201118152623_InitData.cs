    ...
    public partial class InitData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "029c6f59-e05e-4ac8-b7e9-93b79be01b47", "90447226-3e04-406d-b808-486fbe210125", "Visitor", "VISITOR" },
                    { "06c83f6b-a60f-44b6-a5b1-6b9cb827d077", "efc430a1-fc60-4231-be6c-e24713f3e53b", "Administrator", "ADMINISTRATOR" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "128GB", "Snapdragon 720G 8 nhân", 1, new DateTime(2020, 11, 18, 22, 26, 23, 507, DateTimeKind.Local).AddTicks(3352), "iphoneX 64GB - 256GB", "5020mAh,có sạc nhanh", "Android", "IPS LCD, 6.67, Full HD+", "iphoneX.png", "Iphone X ", 1000.0, 200, "8GB" },
                    { 2, "128GB", "Snapdragon 720G 8 nhân", 1, new DateTime(2020, 11, 18, 22, 26, 23, 508, DateTimeKind.Local).AddTicks(3402), "iphoneX 64GB - 256GB", "5020mAh,có sạc nhanh", "Android", "IPS LCD, 6.67, Full HD+", "iphoneX.png", "Samsung Galaxy S10+", 1000.0, 100, "8GB" },
                    { 3, "128GB", "Snapdragon 720G 8 nhân", 1, new DateTime(2020, 11, 18, 22, 26, 23, 508, DateTimeKind.Local).AddTicks(3477), "iphoneX 64GB - 256GB", "5020mAh,có sạc nhanh", "Android", "IPS LCD, 6.67, Full HD+", "iphoneX.png", "Sony Xperia Z1", 1000.0, 100, "8GB" },
                    { 4, "128GB", "Snapdragon 720G 8 nhân", 1, new DateTime(2020, 11, 18, 22, 26, 23, 508, DateTimeKind.Local).AddTicks(3480), "iphoneX 64GB - 256GB", "5020mAh,có sạc nhanh", "Android", "IPS LCD, 6.67, Full HD+", "iphoneX.png", "Sony Xperia Z5", 1000.0, 100, "8GB" }
                });
