...
namespace HomeShopping.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public IActionResult PinDP()
        {
            //var dataContext = _context.Products.Include(p => p.Category)
            //                                    .Where(p=>p.CategoryID==2);
            //return View(dataContext.ToList());
            return View(_context.Products.Where(p => p.Category.CategoryName.Equals("Pin dự phòng")).ToList());
        }
        public IActionResult TaiNghe()
        {

            return View(_context.Products.Where(p => p.Category.CategoryName.Equals("Tai nghe")).ToList());
        }
        public IActionResult LoaBluetooth()
        {

            return View(_context.Products.Where(p => p.Category.CategoryName.Equals("Loa Bluetooth")).ToList());
        }
        public IActionResult CocSac()
        {

            return View(_context.Products.Where(p => p.Category.CategoryName.Equals("Cốc sạc")).ToList());
        }
        public IActionResult CapSac()
        {

            return View(_context.Products.Where(p => p.Category.CategoryName.Equals("Cáp sạc")).ToList());
        }
